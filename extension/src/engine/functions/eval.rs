// Expression evaluation and built-in function dispatch
// ── Moved from execute.rs ──
...
use super::super::execute::LAST_CHANGES;
use super::super::execute::LAST_INSERT_ROWID;
use super::super::execute::{eval_expr, execute, is_truthy, json_val_to_dbvalue, object_name_str};
