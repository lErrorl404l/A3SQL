...
::: {.g-col-12 .g-col-sm-4}
[Getting Started](chapters/Getting-Started.md){.btn-action-primary .btn-action .btn .btn-lg .w-100 role="button"}
:::
::: {.g-col-12 .g-col-sm-4 .mb-2}
[SQL Dialect](chapters/SQL-Dialect.md){.btn-action .btn-secondary .btn .btn-lg .w-100 role="button"}
:::
::: {.g-col-12 .g-col-sm-4 .mb-2}
...
::: {.learn-more}
[SQL Dialect »](chapters/SQL-Dialect.md)
:::
:::
...
::: {.learn-more}
[Patch Framework »](chapters/Patch-Framework.md)
:::
:::
...
::: {.learn-more}
[TCP Connector »](chapters/TCP-Connector.md)
:::
:::
...
[Get Started](chapters/Getting-Started.md){.btn-action-primary .btn-action .btn .btn-lg .w-100 role="button"}
:::
:::
:::