...
"CREATE TABLE IF NOT EXISTS player_save (uid TEXT PRIMARY KEY, unit_type TEXT, pos_x FLOAT, pos_y FLOAT, pos_z FLOAT, dir FLOAT, damage FLOAT, loadout_json TEXT, vehicle TEXT, vehicle_role TEXT, mission_name TEXT, saved_at TEXT)" call a3sql_fnc_execute;
