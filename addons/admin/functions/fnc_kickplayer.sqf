...
private _sql = format ["INSERT INTO server_commands (command, params, source, status, created_at) VALUES ('kick', '%1', 'sqf', 'pending', datetime('now')) RETURNING id", [_params] call a3sql_database_fnc_sqlEscape];
