...
class a3sql_patch_editor {
    ...
    class controls {
        ...
        class AddBtn: RscButton_custom {
            ...
            w = 0.1;
            h = 0.06;
            action = "call a3sql_patch_editor_fnc_gui_addRule";
        };
        ...
        class DeleteBtn: RscButton_custom {
            ...
            w = 0.1;
            h = 0.06;
            action = "call a3sql_patch_editor_fnc_gui_deleteRule";
        };
        ...
        class RefreshBtn: RscButton_custom {
            ...
            w = 0.1;
            h = 0.06;
            action = "call a3sql_patch_editor_fnc_gui_listRules";
        };
        ...
        class SavePresetBtn: RscButton_custom {
            ...
            w = 0.14;
            h = 0.06;
            action = "call a3sql_patch_editor_fnc_gui_savePreset";
        };
        ...
        class LoadPresetBtn: RscButton_custom {
            ...
            w = 0.14;
            h = 0.06;
            action = "call a3sql_patch_editor_fnc_gui_loadPreset";
        };
    };
};
