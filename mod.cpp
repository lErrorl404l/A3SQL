...
picture = "z\a3db\addons\main\data\logo.paa";
logo = "z\a3db\addons\main\data\logo.paa";
logoOver = "z\a3db\addons\main\data\logo.paa";
logoSmall = "z\a3db\addons\main\data\icon.paa";
hideName = 0;
hidePicture = 0;
